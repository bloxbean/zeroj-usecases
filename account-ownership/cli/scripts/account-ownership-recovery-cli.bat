...
rem `prove` and `setup` need a large heap; set AOR_JAVA_OPTS, e.g.
...
java %AOR_JAVA_OPTS% --enable-native-access=ALL-UNNAMED -Dzeroj.allowInsecureTrustedSetup=true -jar "%JAR%" %*
