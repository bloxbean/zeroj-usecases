...
public class OnChainOwnershipService {
    ...
    private final OwnershipCircuitService circuitService;
    ...
    public OnChainOwnershipService(BackendService backendService, Account adminAccount,
                                   OwnershipCircuitService circuitService) {
    ...
    public synchronized void initialize() {
        ...
        var vk = ProofCompressor.compressVk(circuitService.vkSetupResult());
     ...
     */
    public String verifyOwnershipOnChain(Groth16ProofBLS381 proof, byte[] pkh) throws Exception {
        initialize();
