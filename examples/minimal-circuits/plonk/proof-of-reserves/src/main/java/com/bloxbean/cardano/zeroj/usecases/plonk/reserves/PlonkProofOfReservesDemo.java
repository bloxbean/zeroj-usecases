...
public final class PlonkProofOfReservesDemo {
    ...
    private PlonkProofOfReservesDemo() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Compiling annotated BLS12-381 PlonK proof-of-reserves circuit...");
        var prover = new PlonkReserveProofService(SampleReserveStatement.ACCOUNT_COUNT, POT_POWER);
        ...
        var onChain = new PlonkReserveOnChainService(backend, account);
